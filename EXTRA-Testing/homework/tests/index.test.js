...
describe('Function checkSeatStatus', () => {
  ...
  it('checkSeatStatus is a function', () => {
    expect(typeof checkSeatStatus).toBe('function'); // typeof verifico que tipo de dato es
  });
  ...
  it('should throw a TypeError if Second parameter is not a number.', () => {
    expect(() => checkSeatStatus('string','hola')).toThrow(new TypeError('Second parameter is not a number.')); 
    // toThrow  verifica si la función arroja un error
  });
  //5
